import { GetContractReturnType, Client, Address, ContractFunctionArgs, AbiStateMutability, ContractFunctionReturnType, GetEventArgs, PublicClient, Transport, Chain, WalletClient, Account, Hex, GetBalanceReturnType } from 'viem';
...
declare class BucketManager {
    ...
    addInner(bucket: Address, addParams: AddObjectParams): Promise<Result>;
...
declare const walletClientFromPrivateKey: (privateKey: Hex, chain: Chain) => WalletClient<Transport, Chain, Account>;
...
declare class RecallClient {
    ...
    static fromChain(chain?: Chain): RecallClient;
...
export { type AddedBlobs as A, type BlobInfo as B, type CreateBucketEvent as C, type DeleteBlobParams as D, type CreditStats as E, type ApproveCreditParams as F, type GetBlobParams as G, type BuyCreditParams as H, type GetCreditBalanceParams as I, type GetAccountParams as J, type SetAccountSponsorParams as K, type ListResultRaw as L, CreditManager as M, createPublicClientForChain as N, type OverwriteBlobParams as O, type PendingBlobs as P, type QueryResultRaw as Q, type RevokeCreditParams as R, type StorageStats as S, walletClientFromPrivateKey as T, type ContractConfig as U, type ContractOverrides as V, type RecallConfig as W, RecallClient as X, type AccountInfo as Y, type ApproveParams as Z, AccountManager as _, type PendingBlobsCount as a, type PendingBytesCount as b, type BlobStatus as c, type StorageUsage as d, type SubnetStats as e, type AddBlobParams as f, type AddBlobOptions as g, type GetBlobStatusParams as h, BlobManager as i, type AddOptions as j, type ObjectValueRaw as k, type ObjectValue as l, type ListResultRawBucket as m, type ListResultBucket as n, type ListResult as o, type QueryResult as p, type CreateBucketResult as q, type CreateBucketParams as r, type GetObjectParams as s, type DeleteObjectParams as t, type QueryObjectsParams as u, type AddObjectParams as v, BucketManager as w, type CreditBalance as x, type CreditAccount as y, type CreditApproval as z };
