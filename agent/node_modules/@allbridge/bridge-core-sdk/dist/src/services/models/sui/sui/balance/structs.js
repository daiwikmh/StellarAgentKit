...
function isBalance(type) {
    ...
    return type.startsWith(`${index_1.PKG_V26}::balance::Balance` + "<");
}
class Balance {
    __StructClass = true;
    static get $typeName() {
        return `${index_1.PKG_V26}::balance::Balance`;
    }
...
function isSupply(type) {
    type = (0, util_1.compressSuiType)(type);
    return type.startsWith(`${index_1.PKG_V26}::balance::Supply` + "<");
}
class Supply {
    __StructClass = true;
    static get $typeName() {
        return `${index_1.PKG_V26}::balance::Supply`;
    }
    static $numTypeParams = 1;
    static $isPhantom = [true];
