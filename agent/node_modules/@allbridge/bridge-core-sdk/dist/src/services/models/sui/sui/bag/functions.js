...
function add(tx, typeArgs, args) {
    return tx.moveCall({
        target: `${__1.PUBLISHED_AT}::bag::add`,
...
function borrow(tx, typeArgs, args) {
    return tx.moveCall({
        target: `${__1.PUBLISHED_AT}::bag::borrow`,
        typeArguments: typeArgs,
...
function borrowMut(tx, typeArgs, args) {
    return tx.moveCall({
        target: `${__1.PUBLISHED_AT}::bag::borrow_mut`,
        typeArguments: typeArgs,
        arguments: [(0, util_1.obj)(tx, args.bag), (0, util_1.generic)(tx, `${typeArgs[0]}`, args.k)],
    });
}
function contains(tx, typeArg, args) {
    return tx.moveCall({
        target: `${__1.PUBLISHED_AT}::bag::contains`,
...
function destroyEmpty(tx, bag) {
    return tx.moveCall({
        target: `${__1.PUBLISHED_AT}::bag::destroy_empty`,
        arguments: [(0, util_1.obj)(tx, bag)],
    });
}
function isEmpty(tx, bag) {
    return tx.moveCall({
        target: `${__1.PUBLISHED_AT}::bag::is_empty`,
        arguments: [(0, util_1.obj)(tx, bag)],
    });
}
function length(tx, bag) {
    return tx.moveCall({
        target: `${__1.PUBLISHED_AT}::bag::length`,
        arguments: [(0, util_1.obj)(tx, bag)],
    });
}
function remove(tx, typeArgs, args) {
    return tx.moveCall({
        target: `${__1.PUBLISHED_AT}::bag::remove`,
        typeArguments: typeArgs,
        arguments: [(0, util_1.obj)(tx, args.bag), (0, util_1.generic)(tx, `${typeArgs[0]}`, args.k)],
    });
}
function new_(tx) {
    return tx.moveCall({ target: `${__1.PUBLISHED_AT}::bag::new`, arguments: [] });
}
function containsWithType(tx, typeArgs, args) {
    return tx.moveCall({
        target: `${__1.PUBLISHED_AT}::bag::contains_with_type`,
        typeArguments: typeArgs,
        arguments: [(0, util_1.obj)(tx, args.bag), (0, util_1.generic)(tx, `${typeArgs[0]}`, args.k)],
    });
}
