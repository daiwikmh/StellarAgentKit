...
export declare function isUncompressedG1(type: string): boolean;
export interface UncompressedG1Fields {
    dummyField: ToField<"bool">;
}
export type UncompressedG1Reified = Reified<UncompressedG1, UncompressedG1Fields>;
export declare class UncompressedG1 implements StructClass {
    __StructClass: true;
    static get $typeName(): string;
    static readonly $numTypeParams = 0;
    static readonly $isPhantom: readonly [];
    ...
    static get r(): import("../../_framework/reified").StructClassReified<UncompressedG1, UncompressedG1Fields>;
    ...
    static fetch(client: SuiClient, id: string): Promise<UncompressedG1>;
}
