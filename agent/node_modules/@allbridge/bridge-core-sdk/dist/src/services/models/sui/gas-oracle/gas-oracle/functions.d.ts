...
export declare function gasPrice(tx: Transaction, chainData: TransactionObjectInput): import("@mysten/sui/dist/cjs/transactions").TransactionResult;
...
export declare function getId(tx: Transaction, oracle: TransactionObjectInput): import("@mysten/sui/dist/cjs/transactions").TransactionResult;
export declare function getOwnChainData(tx: Transaction, oracle: TransactionObjectInput): import("@mysten/sui/dist/cjs/transactions").TransactionResult;
...
export declare function price(tx: Transaction, chainData: TransactionObjectInput): import("@mysten/sui/dist/cjs/transactions").TransactionResult;
