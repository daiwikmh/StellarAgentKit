...
let LidoSDKwstETH = (() => {
    ...
    return _a = class LidoSDKwstETH extends _classSuper {
            contractAddress() {
                return this.core.getContractAddress(constants_js_1.LIDO_CONTRACT_NAMES.wsteth);
            }
            async erc721Domain() {
                return {
        ...
        (() => {
            ...
            _erc721Domain_decorators = [(0, index_js_1.Logger)('Contracts:'), (0, index_js_1.Cache)(30 * 60 * 1000, ['core.chain.id'])];
...
exports.LidoSDKwstETH = LidoSDKwstETH;
