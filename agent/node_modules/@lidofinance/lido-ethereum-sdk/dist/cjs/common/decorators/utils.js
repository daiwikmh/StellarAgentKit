...
exports.hasCore = exports.hasBus = exports.isCore = exports.callConsoleMessage = void 0;
...
const getLogMode = function () {
    ...
    if ((0, exports.hasBus)(this)) {
        logMode = this.bus.core?.logMode;
    }
...
const hasBus = function (value) {
    return !!value && typeof value === 'object' && 'bus' in value;
};
exports.hasBus = hasBus;
