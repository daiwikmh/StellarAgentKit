...
let LidoSDKApr = (() => {
    ...
    return _a = class LidoSDKApr extends _classSuper {
            constructor(props) {
                ...
                this.events = new index_js_1.LidoSDKEvents({ ...props, core: this.core });
            }
            ...
            async getLastApr() {
                ...
                (0, sdk_error_js_1.invariant)(event, 'Could not find last Rebase event', sdk_error_js_1.ERROR_CODE.READ_ERROR);
            ...
            async getSmaApr(props) {
                ...
                (0, sdk_error_js_1.invariant)(lastEvent, 'Could not find last Rebase event', sdk_error_js_1.ERROR_CODE.READ_ERROR);
                const firstEvent = await this.events.stethEvents.getFirstRebaseEvent({
                    days,
                    fromBlockNumber: lastEvent.blockNumber,
                });
                (0, sdk_error_js_1.invariant)(firstEvent, 'Could not locate first Rebase event. Likely days range greatly preceded first firing of the event.', sdk_error_js_1.ERROR_CODE.READ_ERROR);
        ...
        (() => {
            ...
            _getLastApr_decorators = [(0, index_js_2.Logger)('Statistic:'), (0, index_js_2.ErrorHandler)()];
            _getSmaApr_decorators = [(0, index_js_2.Logger)('Statistic:'), (0, index_js_2.ErrorHandler)()];
