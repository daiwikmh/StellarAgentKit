...
exports.LidoSDKWithdrawContract = void 0;
...
const partStETH_js_1 = require("./abi/partStETH.js");
const partWstETH_js_1 = require("./abi/partWstETH.js");
...
let LidoSDKWithdrawContract = (() => {
    ...
    return _a = class LidoSDKWithdrawContract extends _classSuper {
            async contractAddressWithdrawalQueue() {
                return await this.bus.core.getContractAddress(constants_js_1.LIDO_CONTRACT_NAMES.withdrawalQueue);
            }
            async getContractWithdrawalQueue() {
                const address = await this.contractAddressWithdrawalQueue();
                return (0, viem_1.getContract)({
                    address,
                    abi: withdrawalQueue_js_1.WithdrawalQueueAbi,
                    client: {
            ...
            async contractAddressStETH() {
                return await this.bus.core.getContractAddress(constants_js_1.LIDO_CONTRACT_NAMES.lido);
            }
            async getContractStETH() {
                const address = await this.contractAddressStETH();
                return (0, viem_1.getContract)({
                    address,
                    abi: partStETH_js_1.PartStethAbi,
                    client: {
                        public: this.bus.core.rpcProvider,
                        wallet: this.bus.core.web3Provider,
                    },
            ...
            async contractAddressWstETH() {
                return await this.bus.core.getContractAddress(constants_js_1.LIDO_CONTRACT_NAMES.wsteth);
            }
            async getContractWstETH() {
                const address = await this.contractAddressWstETH();
                return (0, viem_1.getContract)({
                    address,
                    abi: partWstETH_js_1.PartWstethAbi,
                    client: {
                        public: this.bus.core.rpcProvider,
                        wallet: this.bus.core.web3Provider,
                    },
        ...
        (() => {
            ...
            _contractAddressWithdrawalQueue_decorators = [(0, index_js_1.Logger)('Contracts:'), (0, index_js_1.Cache)(30 * 60 * 1000, ['bus.core.chain.id'])];
            _getContractWithdrawalQueue_decorators = [(0, index_js_1.Logger)('Contracts:'), (0, index_js_1.Cache)(30 * 60 * 1000, [
                    'bus.core.chain.id',
                    'contractAddressWithdrawalQueue',
                ])];
            _contractAddressStETH_decorators = [(0, index_js_1.Logger)('Contracts:'), (0, index_js_1.Cache)(30 * 60 * 1000, ['bus.core.chain.id'])];
            _getContractStETH_decorators = [(0, index_js_1.Logger)('Contracts:'), (0, index_js_1.Cache)(30 * 60 * 1000, ['bus.core.chain.id', 'contractAddressStETH'])];
            _contractAddressWstETH_decorators = [(0, index_js_1.Logger)('Contracts:'), (0, index_js_1.Cache)(30 * 60 * 1000, ['bus.core.chain.id'])];
            _getContractWstETH_decorators = [(0, index_js_1.Logger)('Contracts:'), (0, index_js_1.Cache)(30 * 60 * 1000, ['bus.core.chain.id', 'contractAddressWstETH'])];
...
exports.LidoSDKWithdrawContract = LidoSDKWithdrawContract;
