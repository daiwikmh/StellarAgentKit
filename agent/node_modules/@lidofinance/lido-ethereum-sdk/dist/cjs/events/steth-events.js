...
exports.LidoSDKStethEvents = void 0;
const viem_1 = require("viem");
const index_js_1 = require("../common/decorators/index.js");
const constants_js_1 = require("../common/constants.js");
const stethEvents_js_1 = require("./abi/stethEvents.js");
    ...
    return _a = class LidoSDKStethEvents extends _classSuper {
            ...
            async getContractStETH() {
                ...
                return (0, viem_1.getContract)({
                    address,
                    abi: stethEvents_js_1.StethEventsAbi,
            ...
            async getFirstRebaseEvent(props) {
                ...
                for (let dayOffset = 0; dayOffset < DAYS_LIMIT; dayOffset++) {
                    ...
                    (0, sdk_error_js_1.invariantArgument)(from >= 0n, 'Days range precedes first block');
                    const to = from + BLOCKS_BY_DAY;
                    const logs = await this.core.rpcProvider.getLogs({
                        address: contract.address,
                        event: stethEvents_js_1.StethEventsAbi[REBASE_EVENT_ABI_INDEX],
                        fromBlock: from,
                        toBlock: to,
                        strict: true,
                    });
            ...
            async getLastRebaseEvents({ count, stepBlock = _a.DEFAULT_STEP_BLOCK, }) {
                (0, sdk_error_js_1.invariantArgument)(count, 'count must be a positive integer');
                ...
                (0, sdk_error_js_1.invariant)(lastEvent, 'Could not find any rebase events', sdk_error_js_1.ERROR_CODE.READ_ERROR);
            ...
            async getRebaseEvents(props) {
                ...
                const logs = await (0, utils_js_1.requestWithBlockStep)(stepBlock, fromBlock, toBlock, (fromBlock, toBlock) => this.core.rpcProvider.getLogs({
                    address: contract.address,
                    event: stethEvents_js_1.StethEventsAbi[8],
                    fromBlock,
                    toBlock,
                    strict: true,
                }));
            ...
            async parseProps(props) {
                ...
                (0, sdk_error_js_1.invariantArgument)(toBlock >= fromBlock, 'toBlock is lower than fromBlock');
                const { stepBlock = _a.DEFAULT_STEP_BLOCK, maxCount } = props;
                (0, sdk_error_js_1.invariantArgument)(stepBlock > 0, 'stepBlock must be a positive integer');
                if (maxCount !== undefined) {
                    (0, sdk_error_js_1.invariantArgument)(maxCount > 0, 'maxCount must be a positive integer');
                }
                return {
                    ...props,
                    fromBlock,
        ...
        (() => {
            ...
            _getLastRebaseEvent_decorators = [(0, index_js_1.Logger)('Events:'), (0, index_js_1.ErrorHandler)()];
            _getFirstRebaseEvent_decorators = [(0, index_js_1.Logger)('Events:'), (0, index_js_1.ErrorHandler)()];
            _getLastRebaseEvents_decorators = [(0, index_js_1.Logger)('Events:'), (0, index_js_1.ErrorHandler)()];
            _getRebaseEvents_decorators = [(0, index_js_1.Logger)('Events:'), (0, index_js_1.ErrorHandler)()];
            _getLastBlock_decorators = [(0, index_js_1.Logger)('Utils:'), (0, index_js_1.ErrorHandler)()];
...
exports.LidoSDKStethEvents = LidoSDKStethEvents;
