...
let LidoSDKShares = (() => {
    ...
    return _a = class LidoSDKShares extends _classSuper {
            ...
            // Transfer
            async transfer({ account: accountProp, to, amount: _amount, callback = NOOP, from: _from, ...rest }) {
            ...
            async getShareRate() {
                ...
                return calcShareRate(totalEther, totalShares, _a.PRECISION);
            }
            constructor() {
                super(...arguments);
        ...
        (() => {
            ...
            _getContractStETHshares_decorators = [Logger('Contracts:'), Cache(30 * 60 * 1000, ['core.chain.id', 'contractAddressStETH'])];
            ...
            _getTotalSupply_decorators = [Logger('Views:'), ErrorHandler()];
            _getShareRate_decorators = [Logger('Views:'), ErrorHandler()];
