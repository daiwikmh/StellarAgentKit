...
let LidoSDKWithdrawWaitingTime = (() => {
    ...
    return _a = class LidoSDKWithdrawWaitingTime extends _classSuper {
        ...
        (() => {
            ...
            _getWithdrawalWaitingTimeByAmount_decorators = [Logger('API:'), ErrorHandler()];
            _getWithdrawalWaitingTimeByRequestIds_decorators = [Logger('API:'), ErrorHandler()];
...
export { LidoSDKWithdrawWaitingTime };
