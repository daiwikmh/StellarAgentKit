...
import { encodeFunctionData, decodeEventLog, getAbiItem, toEventHash, } from 'viem';
...
let LidoSDKWithdrawClaim = (() => {
    ...
    return _a = class LidoSDKWithdrawClaim extends _classSuper {
        ...
        (() => {
            ...
            _claimRequests_decorators = [Logger('Call:'), ErrorHandler()];
            _claimRequestsEstimateGas_decorators = [Logger('Views:'), ErrorHandler()];
            _claimRequestsSimulateTx_decorators = [Logger('Views:'), ErrorHandler()];
            _claimRequestsPopulateTx_decorators = [Logger('Views:'), ErrorHandler()];
            _sortRequestsWithHints_decorators = [Logger('Utils:')];
            _decodeClaimEvents_decorators = [Logger('Utils:')];
