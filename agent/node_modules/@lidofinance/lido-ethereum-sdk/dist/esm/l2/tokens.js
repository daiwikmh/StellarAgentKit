...
let LidoSDKL2Wsteth = (() => {
    var _a;
    let _classSuper = AbstractLidoSDKErc20;
    ...
    return _a = class LidoSDKL2Wsteth extends _classSuper {
            ...
            async erc721Domain() {
                ...
                const fixedVersion = this.core.chainId === CHAINS.OptimismSepolia ? '1' : version;
                return {
                    fields,
                    name,
        ...
        (() => {
            ...
            _getL2Contract_decorators = [Logger('Contracts:'), Cache(30 * 60 * 1000, ['core.chain.id'])];
            _erc721Domain_decorators = [Cache(30 * 60 * 1000, ['core.chain.id'])];
...
let LidoSDKL2Steth = (() => {
    ...
    return _a = class LidoSDKL2Steth extends _classSuper {
            ...
            // TransferShares
            // Transfer
            async transferShares({ account: accountProp, to, amount: _amount, callback = NOOP, from: _from, ...rest }) {
        ...
        (() => {
            ...
            _getL2Contract_decorators = [Logger('Contracts:'), Cache(30 * 60 * 1000, ['core.chain.id'])];
            _erc721Domain_decorators = [Cache(30 * 60 * 1000, ['core.chain.id'])];
            _balanceShares_decorators = [Logger('Balances:'), ErrorHandler()];
            _convertToShares_decorators = [Logger('Views:'), ErrorHandler()];
            _convertToSteth_decorators = [Logger('Views:'), ErrorHandler()];
            _totalShares_decorators = [Logger('Views:'), ErrorHandler()];
            _transferShares_decorators = [Logger('Call:'), ErrorHandler()];
            _populateTransferShares_decorators = [Logger('Utils:'), ErrorHandler()];
            _simulateTransferShares_decorators = [Logger('Utils:'), ErrorHandler()];
            __esDecorate(_a, null, _getL2Contract_decorators, { kind: "method", name: "getL2Contract", static: false, private: false, access: { has: obj => "getL2Contract" in obj, get: obj => obj.getL2Contract }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_a, null, _erc721Domain_decorators, { kind: "method", name: "erc721Domain", static: false, private: false, access: { has: obj => "erc721Domain" in obj, get: obj => obj.erc721Domain }, metadata: _metadata }, null, _instanceExtraInitializers);
