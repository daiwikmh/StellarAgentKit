...
import { AccountValue, CommonTransactionProps, SignPermitProps } from '../core/types.js';
export type InnerTransactionProps = Required<CommonTransactionProps>;
export type ParsedTransactionProps<TProps extends CommonTransactionProps> = Omit<TProps, 'callback' | 'account'> & {
