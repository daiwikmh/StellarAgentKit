...
import type { ClaimRequestsProps, ClaimResult } from './types.js';
export declare class LidoSDKWithdrawClaim extends BusModule {
    private static CLAIM_SIGNATURE;
    claimRequests(props: ClaimRequestsProps): Promise<TransactionResult<ClaimResult>>;
    claimRequestsEstimateGas(props: NoTxOptions<ClaimRequestsProps>, options?: TransactionOptions): Promise<bigint>;
    claimRequestsSimulateTx(props: NoTxOptions<ClaimRequestsProps>): Promise<import("viem").SimulateContractReturnType<readonly [{
        ...
        readonly stateMutability: "view";
        readonly type: "function";
    }], "claimWithdrawals", readonly [readonly bigint[], readonly bigint[]], import("viem").Chain | undefined, import("viem").Account | undefined, undefined, import("viem").JsonRpcAccount>>;
    claimRequestsPopulateTx(props: NoTxOptions<ClaimRequestsProps>): Promise<PopulatedTransaction>;
    private sortRequestsWithHints;
    private decodeClaimEvents;
}
