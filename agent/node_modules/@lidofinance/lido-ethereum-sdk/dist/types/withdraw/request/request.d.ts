import { type TransactionResult, NoTxOptions, PopulatedTransaction, TransactionOptions } from '../../core/types.js';
import { BusModule } from '../bus-module.js';
import type { RequestWithPermitProps, RequestProps, SplitAmountToRequestsProps, RequirePermit, WithdrawalResult } from './types.js';
export declare class LidoSDKWithdrawRequest extends BusModule {
    private static WITHDRAW_SIGNATURE;
    splitAmountToRequests({ amount: _amount, token, }: SplitAmountToRequestsProps): Promise<Array<bigint>>;
    requestWithdrawal(props: RequestProps): Promise<TransactionResult<WithdrawalResult>>;
    requestWithdrawalEstimateGas(props: NoTxOptions<RequestProps>, options?: TransactionOptions): Promise<bigint>;
    requestWithdrawalSimulateTx(props: NoTxOptions<RequestProps>): Promise<import("viem").SimulateContractReturnType<readonly [{
        ...
        readonly inputs: readonly [];
        readonly name: "BUNKER_MODE_DISABLED_TIMESTAMP";
        ...
        readonly inputs: readonly [];
        readonly name: "MANAGE_TOKEN_URI_ROLE";
        readonly outputs: readonly [{
            readonly internalType: "bytes32";
            readonly name: "";
            readonly type: "bytes32";
        ...
        readonly inputs: readonly [];
        readonly name: "MAX_BATCHES_LENGTH";
        readonly outputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "";
            readonly type: "uint256";
        ...
        readonly inputs: readonly [];
        readonly name: "MAX_STETH_WITHDRAWAL_AMOUNT";
        readonly outputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "";
            readonly type: "uint256";
        ...
        readonly inputs: readonly [];
        readonly name: "MIN_STETH_WITHDRAWAL_AMOUNT";
        readonly outputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "";
            readonly type: "uint256";
        ...
        readonly inputs: readonly [];
        readonly name: "bunkerModeSinceTimestamp";
        readonly outputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "";
            readonly type: "uint256";
        ...
        readonly name: "findCheckpointHints";
        readonly outputs: readonly [{
            readonly internalType: "uint256[]";
        ...
        readonly inputs: readonly [{
            readonly internalType: "bool";
            readonly name: "_isBunkerModeNow";
            readonly type: "bool";
        }, {
            readonly internalType: "uint256";
            readonly name: "_bunkerStartTimestamp";
            readonly type: "uint256";
        }, {
            readonly internalType: "uint256";
            readonly name: "_currentReportTimestamp";
            readonly type: "uint256";
        }];
        readonly name: "onOracleReport";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }, {
        ...
        readonly name: "prefinalize";
        readonly outputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "ethToLock";
            readonly type: "uint256";
        }, {
            readonly internalType: "uint256";
            readonly name: "sharesToBurn";
        ...
        readonly inputs: readonly [{
            readonly internalType: "address";
            readonly name: "_nftDescriptorAddress";
            readonly type: "address";
        }];
        readonly name: "setNFTDescriptorAddress";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }, {
        ...
        readonly stateMutability: "view";
        readonly type: "function";
    }], "requestWithdrawals", readonly [readonly bigint[], `0x${string}`], import("viem").Chain | undefined, import("viem").Account | undefined, undefined, import("viem").JsonRpcAccount> | import("viem").SimulateContractReturnType<readonly [{
        readonly inputs: readonly [];
        readonly name: "AdminZeroAddress";
        readonly type: "error";
    }, {
        ...
        readonly stateMutability: "view";
        readonly type: "function";
    }], "requestWithdrawalsWstETH", readonly [readonly bigint[], `0x${string}`], import("viem").Chain | undefined, import("viem").Account | undefined, undefined, import("viem").JsonRpcAccount>>;
    requestWithdrawalPopulateTx(props: NoTxOptions<RequestWithPermitProps>): Promise<PopulatedTransaction>;
    requestWithdrawalWithPermit(props: RequestWithPermitProps): Promise<TransactionResult<WithdrawalResult>>;
    requestWithdrawalWithPermitEstimateGas(props: NoTxOptions<RequirePermit<RequestWithPermitProps>>, options?: TransactionOptions): Promise<bigint>;
    requestWithdrawalWithPermitSimulateTx(props: NoTxOptions<RequirePermit<RequestWithPermitProps>>): Promise<import("viem").SimulateContractReturnType<readonly [{
        readonly inputs: readonly [];
        readonly name: "AdminZeroAddress";
        readonly type: "error";
    }, {
        ...
        readonly stateMutability: "view";
        readonly type: "function";
    }], "requestWithdrawalsWithPermit", readonly [readonly bigint[], `0x${string}`, {
        value: bigint;
        deadline: bigint;
        v: number;
        r: `0x${string}`;
        s: `0x${string}`;
    }], import("viem").Chain | undefined, import("viem").Account | undefined, undefined, import("viem").JsonRpcAccount> | import("viem").SimulateContractReturnType<readonly [{
        readonly inputs: readonly [];
        readonly name: "AdminZeroAddress";
        readonly type: "error";
    }, {
        ...
        readonly stateMutability: "view";
        readonly type: "function";
    }], "requestWithdrawalsWstETHWithPermit", readonly [readonly bigint[], `0x${string}`, {
        value: bigint;
        deadline: bigint;
        v: number;
        r: `0x${string}`;
        s: `0x${string}`;
    }], import("viem").Chain | undefined, import("viem").Account | undefined, undefined, import("viem").JsonRpcAccount>>;
    requestWithdrawalWithPermitPopulateTx(props: NoTxOptions<RequirePermit<RequestWithPermitProps>>): Promise<PopulatedTransaction>;
    private decodeWithdrawEvents;
}
